...
const {getItems,getItem,createItems,getStatsJugadoresByEquipo,updateItems,getJugadoresByEquipo,deleteItems,getItemsFilter} = require('../controllers/jugadores')
